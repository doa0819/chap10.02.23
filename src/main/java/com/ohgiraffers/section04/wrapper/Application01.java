...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   Wrapper 클래스 라고 한다.(주방에서 사욯하는 랩 과 같이 감싼다는 의미이다.)
        *  */
        ...
        * */
        ...
        int inValue = 20;
        Integer boxingNumber1 = new Integer(inValue);    // 인스턴스화(박싱)

        int unBoxingNumber1 = boxingNumber1.intValue();   // 언박싱 (intValue()) 이용)

        Integer boxingNumber2 = inValue;               // 오토방식
        ...
        Integer integerNum3 = 20;                          //오토방식
        Integer integerNum4 = 20;                          //오토방식
