...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. Object 클래스의 equals() 매소드 오버라이딩 목적을 이해하고, 활용할 수 있다. */
        /*필기.
        *  equals() 메소드 오버라이딩
        *  equals() 메소드 매개변수로 전달받은 인스턴스와 == 연산하여 true or false 를 반환한다.
        *   즉, 동일한 인스턴스인 지 비교하는 역할을 한다.
        *   동일 : 주소 까지 동일 동등: 값만 똑같다
        *
        * 필기.
        *  동일객체와 동등객체
        ...
        *  */
        ...
        System.out.println("두 인스턴스의 equals() 비고 : " + (book1.equals(book2)));
