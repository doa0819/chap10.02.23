...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   문자열 객체를 만드는 방법
        *   "" 리터럴 형태 : 동일한 값을 가지는 인스턴스를 단인 인스턴스로 관리한다. (singleton)
        *   new String("문자열") : 매번 새로운 인스턴스 생성
        * */

        String str1 = "java";
        String str2 = "java";
        String str3 = new String("java");       // new 로 할당받아서 새로운 공간을 만들어 준다 (값은 같지만 주소는 두개 이다.)
        ...
        * */
        ...
        System.out.println("st2의 hashcode : " + str2.hashCode());
        System.out.println("str3의 hashcode : " + str3.hashCode());
        System.out.println("str4의 hashcode : " + str4.hashCode());

        /* 필기.
        *   equals() : String 클래스의 equals() 메소드는 인스턴스 비교가 아닌 문자열값을 비교
        *               동일한 값을 가지는 경우 true, 다른 값을 가지는 경우 false 를 반환 하도록
        *               equals() 메소드를 재정의 해두었다.
        *               따라서 문자열 인스턴스 생성 방식과 상관 없이 동일한 문자열인 지 비교하기 위해
        *               == 대신 equals() 메소드를 사용해야 한다.
        * 666+6+6++5+2+++2154919141414
        *
        * 5
        * 44
        * 56*/
